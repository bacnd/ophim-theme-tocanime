...
namespace Ophim\ThemeTocAnime\Controllers;
...
class ThemeTocAnimeController
{
    ...
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themetocanime.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themetocanime.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themetocanime.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themetocanime.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
