...
namespace Ophim\ThemeTocAnime;

use Illuminate\Foundation\Support\Providers\AuthServiceProvider as ServiceProvider;

class ThemeTocAnimeServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('themes/tocanime')
        ], 'tocanime-assets');
    }
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'tocanime' => [
                ...
                'package_name' => 'ophimcms/theme-tocanime',
                'publishes' => ['tocanime-assets'],
                'preview_image' => '',
                'options' => [
                    [
                        'name' => 'per_page_limit',
